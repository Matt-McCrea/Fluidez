...

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué argumento oponen los partidos más reticentes a ampliar el derecho al voto?', options: ['Que ningún extranjero paga impuestos en el municipio', 'Que la ciudadanía plena conlleva deberes que no deberían separarse del derecho al voto', 'Que no existe ningún interés por parte de los extranjeros en votar'], answer: 1 },
    { type: 'short', q: '¿Qué han empezado a crear algunos ayuntamientos como solución intermedia? (unas palabras)', accept: ['consejos consultivos', 'consejos consultivos de residentes extranjeros'] },
    { type: 'translate', line: 'la legitimidad democrática de un ayuntamiento debería fundamentarse, ante todo, en representar a quienes efectivamente conviven, trabajan y utilizan los servicios públicos', model: 'a city council\'s democratic legitimacy should be grounded, above all, in representing those who actually live, work, and use the public services' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Por qué generó condena el caso del científico que modificó embriones frente al VIH?', options: ['Por la falta de supervisión ética y transparencia, no por la viabilidad técnica', 'Porque el procedimiento resultó técnicamente imposible', 'Porque ningún embrión modificado llegó a nacer'], answer: 0 },
    { type: 'short', q: '¿Qué mantienen actualmente la mayoría de países con capacidad tecnológica suficiente? (unas palabras)', accept: ['moratorias', 'moratorias explícitas', 'moratorias sobre la edición germinal'] },
    { type: 'translate', line: 'la edición germinal, que modifica embriones o células reproductivas de manera que el cambio genético se transmite a todas las generaciones posteriores', model: 'germline editing, which modifies embryos or reproductive cells so that the genetic change is passed on to all subsequent generations' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué función cumplía el uso tradicional del monte por la población rural?', options: ['Ninguna función relevante para la prevención de incendios', 'Mantenía una discontinuidad de la masa forestal que dificultaba la propagación del fuego', 'Aumentaba deliberadamente el riesgo de incendios'], answer: 1 },
    { type: 'short', q: '¿Qué tipo de programa han empezado a probar algunas administraciones forestales? (unas palabras)', accept: ['pastoreo dirigido', 'programas de pastoreo dirigido'] },
    { type: 'translate', line: 'constituye en la práctica un combustible acumulado durante décadas enteras a la espera únicamente de la chispa adecuada para propagarse', model: 'it constitutes, in practice, fuel accumulated over entire decades, waiting only for the right spark to spread' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué alternativa al enfoque sancionador han empezado a probar algunas administraciones?', options: ['Incentivos fiscales para facilitar la transición gradual hacia la formalidad', 'Multas todavía más elevadas para los infractores', 'La eliminación total de cualquier control fiscal'], answer: 0 },
    { type: 'short', q: '¿A qué sectores afecta especialmente la economía sumergida, según el texto? (unas palabras)', accept: ['hostelería estacional, construcción y servicio doméstico', 'hostelería, construcción, servicio doméstico'] },
    { type: 'translate', line: 'los trabajadores empleados de forma completamente informal carecen, en la práctica, de cualquier protección legal real ante un despido improcedente', model: 'workers employed completely informally lack, in practice, any real legal protection against unfair dismissal' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué función cumplía el periódico local que ningún medio nacional replicaba, según el texto?', options: ['Ninguna función distinta a la de cualquier medio nacional', 'Un control informativo sobre el ayuntamiento a una escala muy local y específica', 'La cobertura de deportes internacionales'], answer: 1 },
    { type: 'short', q: '¿Cuántos años llevaba publicándose el periódico antes de cerrar? (una cifra)', accept: ['casi ochenta años', 'ochenta años', '80 años'] },
    { type: 'translate', line: 'la desaparición progresiva de medios de comunicación estrictamente locales ha generado, en amplias zonas rurales de distintos países, auténticos «desiertos informativos»', model: 'the progressive disappearance of strictly local media outlets has generated, in wide rural areas of various countries, genuine "news deserts"' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Cuál fue, según el texto, el mayor desafío práctico de la pareja?', options: ['Encontrar oficiantes religiosos dispuestos a colaborar', 'Gestionar las expectativas encontradas de ambas familias sobre detalles simbólicos', 'El coste económico de dos ceremonias distintas'], answer: 1 },
    { type: 'short', q: '¿Cuánto tiempo separó las dos ceremonias religiosas? (una cifra)', accept: ['un día', 'apenas un día'] },
    { type: 'translate', line: 'dejando a los propios hijos, cuando alcancen una edad suficiente para comprenderlo plenamente, la decisión final sobre con cuál de ambas tradiciones, si alguna, prefieren identificarse personalmente', model: 'leaving the children themselves, once they reach an age old enough to fully understand it, the final decision about which of the two traditions, if any, they personally prefer to identify with' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué le impedía a Carla revelar su participación mientras duraba la colaboración?', options: ['Una cláusula de confidencialidad estricta en su contrato', 'La falta de pruebas de su propia autoría', 'Una prohibición legal general del sector musical'], answer: 0 },
    { type: 'short', q: '¿Cuántos años duró la colaboración de Carla con el artista? (una cifra)', accept: ['casi quince años', 'quince años', '15 años'] },
    { type: 'translate', line: 'reconocer abiertamente la participación decisiva de compositores externos podría, según temen algunas discográficas, debilitar precisamente esa conexión emocional que el propio público establece con la figura del artista', model: 'openly acknowledging the decisive involvement of outside composers could, as some record labels fear, precisely weaken that emotional connection the audience itself builds with the artist figure' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué preocupación plantean los críticos de estos programas?', options: ['Que resultan demasiado caros para la mayoría de solicitantes', 'Que facilitan que personas bajo investigación por delitos económicos dificulten el rastreo de sus activos', 'Que los países emisores pierden dinero con el programa'], answer: 1 },
    { type: 'short', q: '¿En qué región se concentran especialmente estos programas, según el texto? (una palabra)', accept: ['Caribe', 'el Caribe'] },
    { type: 'translate', line: 'facilitan en la práctica que individuos con patrimonios considerables, incluyendo en algunos casos ya documentados a personas bajo investigación por delitos económicos graves en su país de origen, obtengan una nueva identidad legal que dificulta considerablemente el rastreo internacional de sus activos financieros', model: 'they make it easier, in practice, for individuals with considerable wealth — including, in some already documented cases, people under investigation for serious economic crimes in their home country — to obtain a new legal identity that considerably hinders the international tracing of their financial assets' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué medida implementó la empresa tras conocer los resultados de la auditoría?', options: ['Un sistema de bandas salariales fijas y no negociables individualmente', 'Un aumento general de sueldo para todos los empleados', 'Ninguna medida concreta, solo un comunicado interno'], answer: 0 },
    { type: 'short', q: '¿Cuál fue el porcentaje de diferencia salarial media encontrado? (una cifra)', accept: ['14%', 'catorce por ciento', '14 por ciento'] },
    { type: 'translate', line: 'las mujeres que sí negocian con firmeza equivalente reciben a menudo, según revelan estudios de percepción social, valoraciones bastante más negativas por parte de sus propios superiores que hombres que negocian exactamente de la misma manera', model: 'women who do negotiate with equivalent firmness often receive, as social-perception studies reveal, considerably more negative evaluations from their own superiors than men who negotiate in exactly the same way' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué han empezado a exigir algunas administraciones educativas sin prohibir la práctica?', options: ['La escolarización obligatoria a partir de cierta edad', 'Evaluaciones periódicas obligatorias del progreso académico', 'El pago de una tasa educativa anual'], answer: 1 },
    { type: 'short', q: '¿Qué experiencia previa negativa motiva a un tercer grupo de familias, según el texto? (unas palabras)', accept: ['acoso escolar', 'el acoso escolar'] },
    { type: 'translate', line: 'la convivencia diaria con compañeros de edades similares mediante estructuras escolares formales cumple una función de aprendizaje social que ningún entorno exclusivamente familiar, por rico y estimulante que resulte en otros aspectos, puede replicar plenamente', model: 'daily coexistence with peers of similar ages through formal school structures fulfills a social-learning function that no exclusively family environment, however rich and stimulating it may be in other respects, can fully replicate' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué cambio introdujo la reforma legal posterior?', options: ['Eliminó por completo la posibilidad de rectificar el documento', 'Sustituyó el requisito médico por una declaración de autodeterminación ante notario', 'Añadió requisitos médicos todavía más estrictos'], answer: 1 },
    { type: 'short', q: '¿Cuánto tiempo tardó Adrián en completar todo el proceso? (una cifra)', accept: ['casi tres años', 'tres años', '3 años'] },
    { type: 'translate', line: 'obligar a las personas solicitantes a demostrar ante terceros un sufrimiento psicológico específico simplemente para acceder a un documento que reflejara correctamente su propia identidad', model: 'forcing applicants to prove specific psychological suffering to third parties simply to access a document that correctly reflected their own identity' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué consideran los hijos de Fermina lo más difícil del proceso?', options: ['Vaciar físicamente los espacios acumulados', 'Aprender a no presionar excesivamente a su madre para acelerar el proceso', 'Encontrar una terapeuta especializada disponible'], answer: 1 },
    { type: 'short', q: '¿Cuántas habitaciones de la casa habían quedado inaccesibles? (una cifra)', accept: ['dos', '2'] },
    { type: 'translate', line: 'cada elemento acumulado representa, para quien lo conserva, un valor sentimental o una utilidad futura potencial que resulta extraordinariamente difícil de descartar racionalmente', model: 'each accumulated item represents, for whoever keeps it, a sentimental value or a potential future usefulness that turns out extraordinarily difficult to rationally discard' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué le costó más asimilar a Lucía tras descubrir que tenía sinestesia?', options: ['La propia peculiaridad neurológica en sí misma', 'La idea de que su experiencia subjetiva podría diferir radicalmente de la de otras personas', 'El miedo a ser diagnosticada con alguna enfermedad'], answer: 1 },
    { type: 'short', q: '¿De qué color percibe Lucía el número siete? (una palabra)', accept: ['verde'] },
    { type: 'translate', line: 'consiste en una conexión perceptiva involuntaria entre dos o más sentidos que en la mayoría de las personas permanecen completamente separados entre sí', model: 'it consists of an involuntary perceptual connection between two or more senses that in most people remain completely separate from one another' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué le preocupa más a Ignacio de cara al futuro, según el texto?', options: ['El coste económico del cuidado', 'Qué ocurrirá con su hermano cuando él ya no pueda seguir cuidándolo', 'La opinión de sus amigos sobre su situación'], answer: 1 },
    { type: 'short', q: '¿Con qué edad asumió Ignacio la tutela legal de su hermano? (una cifra)', accept: ['veinticuatro', '24'] },
    { type: 'translate', line: 'seguía sintiéndose, en el fondo, el hermano mayor de siempre, pero ahora debía además tomar decisiones médicas, económicas y educativas', model: 'deep down he still felt like the same older brother as always, but now he also had to make medical, financial and educational decisions' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿En qué ha cambiado la forma de escribir de Óscar tras recuperar parcialmente el olfato?', options: ['Ha dejado de escribir sobre comida por completo', 'Dedica más atención a la textura, temperatura y presentación visual', 'Escribe exclusivamente sobre vinos'], answer: 1 },
    { type: 'short', q: '¿Cuántos años llevaba Óscar ejerciendo como crítico gastronómico? (una cifra)', accept: ['más de quince años', 'quince años', '15 años'] },
    { type: 'translate', line: 'la enorme variedad de matices que asociamos habitualmente a un plato concreto llega en realidad, casi en su totalidad, a través de los receptores olfativos', model: 'the enormous variety of nuances we normally associate with a particular dish actually arrives, almost entirely, through the olfactory receptors' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Cómo funciona la comunidad de observadores de aves de la región de Beatriz?', options: ['De forma puramente solitaria y competitiva', 'Compartiendo avistamientos en tiempo real mediante mensajería instantánea', 'Solo se comunican una vez al año'], answer: 1 },
    { type: 'short', q: '¿Cuántas especies registró finalmente Beatriz al cerrar el año? (una cifra)', accept: ['doscientas noventa y siete', '297'] },
    { type: 'translate', line: 'implica levantarse regularmente antes del amanecer para aprovechar la franja horaria de mayor actividad de determinadas especies', model: 'it involves regularly getting up before dawn to make the most of the time window when certain species are most active' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué consideran moralmente arbitrario los críticos de la legislación actual?', options: ['Que exista cualquier protección legal para inquilinos', 'La distinción entre primera vivienda habitual y segunda residencia desde la perspectiva del propietario', 'Que la policía pueda intervenir en algún caso'], answer: 1 },
    { type: 'short', q: '¿En cuántas horas actúan los nuevos protocolos policiales más ágiles? (una cifra)', accept: ['48', 'cuarenta y ocho', 'cuarenta y ocho horas'] },
    { type: 'translate', line: 'dejando durante todo ese periodo al propietario legítimo completamente privado del uso de su propio inmueble', model: 'leaving the legitimate owner, throughout that entire period, completely deprived of the use of their own property' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué solución han empezado a negociar algunas administraciones locales?', options: ['La reapertura permanente de todas las sucursales cerradas', 'Oficinas móviles itinerantes que visitan pueblos pequeños periódicamente', 'Formación obligatoria en tecnología para todos los mayores'], answer: 1 },
    { type: 'short', q: '¿Cuántos años tiene Encarnación? (una cifra)', accept: ['78', 'setenta y ocho'] },
    { type: 'translate', line: 'dependen todavía en mayor medida de la propia atención presencial que el resto de la población más joven ya ha abandonado voluntariamente', model: 'they still depend to a greater extent on in-person service itself, which the rest of the younger population has already voluntarily abandoned' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿Qué diferencia principal existe entre estos servicios y una tarjeta de crédito tradicional, según el texto?', options: ['Ninguna diferencia relevante', 'No existe obligación legal actual de compartir información crediticia entre las distintas empresas del sector', 'Los servicios de pago aplazado siempre cobran intereses más altos'], answer: 1 },
    { type: 'short', q: '¿Qué porcentaje aproximado de jóvenes encuestados ha usado este tipo de servicio? (una cifra)', accept: ['casi la mitad', 'la mitad', '50%'] },
    { type: 'translate', line: 'la facilidad extrema con la que se aprueba cada compra individual, combinada con la sensación psicológica de estar gestionando cantidades pequeñas y manejables en cada plazo concreto, puede llevar fácilmente a los consumidores a acumular, sin plena conciencia del total agregado, varios compromisos de pago simultáneos', model: 'the extreme ease with which each individual purchase is approved, combined with the psychological sense of handling small, manageable amounts in each individual installment, can easily lead consumers to accumulate, without full awareness of the aggregate total, several simultaneous payment commitments' }
  ]
},

{
  ...
  questions: [
    ...
    { type: 'mcq', q: '¿A qué atribuyen los investigadores buena parte del sesgo de género documentado en el diagnóstico?', options: ['A que las mujeres exageran sistemáticamente sus síntomas', 'A que los ensayos clínicos históricos se realizaron mayoritariamente sobre sujetos masculinos', 'A la falta de médicas mujeres en el sistema sanitario'], answer: 1 },
    { type: 'short', q: '¿Cuántos médicos consultó Silvia antes del diagnóstico certero? (una cifra)', accept: ['once', '11'] },
