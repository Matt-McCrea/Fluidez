...
window.APPLY_ITEMS = [
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (comer) paella con mis amigos.', inf: 'comer', tense: 'preterito', person: 'yo', en: 'Yesterday I ate paella with my friends.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche nosotros ___ (ir) al cine.', inf: 'ir', tense: 'preterito', person: 'nosotros', en: 'Last night we went to the cinema.' },
  ...
  { type: 'cloze', level: 1, text: 'El año pasado nosotros ___ (comprar) una casa.', inf: 'comprar', tense: 'preterito', person: 'nosotros', en: 'Last year we bought a house.' },
  ...
  { type: 'cloze', level: 1, text: 'Ellos ___ (escribir) muchas cartas el mes pasado.', inf: 'escribir', tense: 'preterito', person: 'ellos', en: 'They wrote many letters last month.' },
  ...
  { type: 'cloze', level: 1, text: 'Ella ya ___ (terminar) el trabajo.', inf: 'terminar', tense: 'perfecto', person: 'él/ella', en: 'She has already finished the work.' },
  ...
  // ---- level 2: preterito ----
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (comprar) un regalo para mi hermana.', inf: 'comprar', tense: 'preterito', person: 'yo', en: 'Yesterday I bought a gift for my sister.' },
  { type: 'cloze', level: 1, text: '¿A qué hora ___ (llegar) tú anoche?', inf: 'llegar', tense: 'preterito', person: 'tú', en: 'What time did you arrive last night?' },
  { type: 'cloze', level: 1, text: 'El mes pasado, mi jefe ___ (hacer) un viaje a Japón.', inf: 'hacer', tense: 'preterito', person: 'él/ella', en: 'Last month, my boss took a trip to Japan.' },
  { type: 'cloze', level: 1, text: 'La semana pasada nosotros ___ (ver) una película muy buena.', inf: 'ver', tense: 'preterito', person: 'nosotros', en: 'Last week we saw a very good movie.' },
  { type: 'cloze', level: 1, text: '¿A qué hora ___ (salir) vosotros de la fiesta?', inf: 'salir', tense: 'preterito', person: 'vosotros', en: 'What time did you all leave the party?' },
  { type: 'cloze', level: 1, text: 'Mis padres ___ (decir) la verdad ayer por la noche.', inf: 'decir', tense: 'preterito', person: 'ellos', en: 'My parents told the truth yesterday at night.' },
  { type: 'cloze', level: 1, text: 'El lunes pasado yo ___ (empezar) un curso de cocina.', inf: 'empezar', tense: 'preterito', person: 'yo', en: 'Last Monday I started a cooking class.' },
  ...
  // ---- level 3: perfecto ----
  { type: 'cloze', level: 1, text: 'Yo ya ___ (terminar) mis exámenes de este curso.', inf: 'terminar', tense: 'perfecto', person: 'yo', en: 'I have already finished my exams for this course.' },
  { type: 'cloze', level: 1, text: '¿___ (ver) tú alguna vez las pirámides de Egipto?', inf: 'ver', tense: 'perfecto', person: 'tú', en: 'Have you ever seen the pyramids of Egypt?' },
  { type: 'cloze', level: 1, text: 'Nosotros siempre ___ (vivir) en esta ciudad.', inf: 'vivir', tense: 'perfecto', person: 'nosotros', en: 'We have always lived in this city.' },
  { type: 'cloze', level: 1, text: 'Mis compañeros ya ___ (escribir) el informe final.', inf: 'escribir', tense: 'perfecto', person: 'ellos', en: 'My colleagues have already written the final report.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (enviar) el informe a mi jefe.', inf: 'enviar', tense: 'preterito', person: 'yo', en: 'Yesterday I sent the report to my boss.' },
  { type: 'cloze', level: 1, text: 'El año pasado tú ___ (elegir) estudiar medicina.', inf: 'elegir', tense: 'preterito', person: 'tú', en: 'Last year you chose to study medicine.' },
  { type: 'cloze', level: 1, text: 'La empresa ___ (despedir) a varios empleados el mes pasado.', inf: 'despedir', tense: 'preterito', person: 'él/ella', en: 'The company laid off several employees last month.' },
  { type: 'cloze', level: 1, text: 'El año pasado nosotros ___ (invertir) en un negocio nuevo.', inf: 'invertir', tense: 'preterito', person: 'nosotros', en: 'Last year we invested in a new business.' },
  { type: 'cloze', level: 1, text: 'Vosotros ___ (andar) por la playa toda la tarde ayer.', inf: 'andar', tense: 'preterito', person: 'vosotros', en: 'You all walked along the beach all afternoon yesterday.' },
  { type: 'cloze', level: 1, text: 'Los profesores ___ (corregir) los exámenes anoche.', inf: 'corregir', tense: 'preterito', person: 'ellos', en: 'The teachers corrected the exams last night.' },
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (gastar) demasiado dinero en ropa.', inf: 'gastar', tense: 'preterito', person: 'yo', en: 'Yesterday I spent too much money on clothes.' },
  { type: 'cloze', level: 1, text: 'Tú ___ (llorar) mucho en la boda de tu hermana.', inf: 'llorar', tense: 'preterito', person: 'tú', en: "You cried a lot at your sister's wedding." },
  { type: 'cloze', level: 1, text: 'Cuando vio el regalo, ella ___ (sonreír) de felicidad.', inf: 'sonreír', tense: 'preterito', person: 'él/ella', en: 'When she saw the gift, she smiled with happiness.' },
  ...
  { type: 'cloze', level: 1, text: 'Yo ya ___ (enviar) el correo esta mañana.', inf: 'enviar', tense: 'perfecto', person: 'yo', en: 'I have already sent the email this morning.' },
  { type: 'cloze', level: 1, text: '¿___ (descansar) tú lo suficiente esta semana?', inf: 'descansar', tense: 'perfecto', person: 'tú', en: 'Have you rested enough this week?' },
  { type: 'cloze', level: 1, text: 'Mi hermana ya ___ (elegir) el vestido para la boda.', inf: 'elegir', tense: 'perfecto', person: 'él/ella', en: 'My sister has already chosen the dress for the wedding.' },
  { type: 'cloze', level: 1, text: 'Este año nosotros ___ (ahorrar) más que nunca.', inf: 'ahorrar', tense: 'perfecto', person: 'nosotros', en: 'This year we have saved more than ever.' },
  { type: 'cloze', level: 1, text: 'Mis jefes ya ___ (contratar) a un nuevo diseñador.', inf: 'contratar', tense: 'perfecto', person: 'ellos', en: 'My bosses have already hired a new designer.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (comer) en un restaurante nuevo.', inf: 'comer', tense: 'preterito', person: 'nosotros', en: 'Yesterday we ate at a new restaurant.' },
  ...
  { type: 'cloze', level: 1, text: 'El año pasado yo ___ (vivir) en otra ciudad.', inf: 'vivir', tense: 'preterito', person: 'yo', en: 'Last year I lived in another city.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (tener) una reunión muy larga.', inf: 'tener', tense: 'preterito', person: 'yo', en: 'Yesterday I had a very long meeting.' },
  { type: 'cloze', level: 1, text: 'El sábado pasado nosotros ___ (ir) al cine.', inf: 'ir', tense: 'preterito', person: 'nosotros', en: 'Last Saturday we went to the movies.' },
  { type: 'cloze', level: 1, text: 'Ella no ___ (poder) terminar el examen a tiempo.', inf: 'poder', tense: 'preterito', person: 'él/ella', en: "She couldn't finish the exam on time." },
  ...
  { type: 'cloze', level: 1, text: 'Ayer mis padres me ___ (decir) la verdad.', inf: 'decir', tense: 'preterito', person: 'ellos', en: 'Yesterday my parents told me the truth.' },
  ...
  { type: 'cloze', level: 1, text: 'La semana pasada nosotros ___ (ver) una película muy triste.', inf: 'ver', tense: 'preterito', person: 'nosotros', en: 'Last week we saw a very sad movie.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer tú ___ (venir) muy tarde a la oficina.', inf: 'venir', tense: 'preterito', person: 'tú', en: 'Yesterday you came very late to the office.' },
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (salir) con mis amigos.', inf: 'salir', tense: 'preterito', person: 'yo', en: 'Last night I went out with my friends.' },
  { type: 'cloze', level: 1, text: 'Mi hermano ___ (traer) el postre a la fiesta el sábado.', inf: 'traer', tense: 'preterito', person: 'él/ella', en: 'My brother brought the dessert to the party on Saturday.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche nosotros no ___ (oír) el despertador.', inf: 'oír', tense: 'preterito', person: 'nosotros', en: "Last night we didn't hear the alarm clock." },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (pedir) el mismo plato de siempre.', inf: 'pedir', tense: 'preterito', person: 'yo', en: 'Yesterday I ordered the same dish as always.' },
  ...
  { type: 'cloze', level: 1, text: 'Después de mucho esfuerzo, ella ___ (conseguir) el trabajo.', inf: 'conseguir', tense: 'preterito', person: 'él/ella', en: 'After a lot of effort, she got the job.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (sentir) mucho frío en la calle.', inf: 'sentir', tense: 'preterito', person: 'yo', en: 'Yesterday I felt very cold in the street.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche nosotros ___ (leer) el mismo libro juntos.', inf: 'leer', tense: 'preterito', person: 'nosotros', en: 'Last night we read the same book together.' },
  ...
  { type: 'cloze', level: 1, text: 'Cuando escuché el chiste, yo ___ (reír) mucho.', inf: 'reír', tense: 'preterito', person: 'yo', en: 'When I heard the joke, I laughed a lot.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer tú ___ (conducir) hasta la costa.', inf: 'conducir', tense: 'preterito', person: 'tú', en: 'Yesterday you drove to the coast.' },
  ...
  { type: 'cloze', level: 1, text: 'El traductor ___ (traducir) el documento en una hora.', inf: 'traducir', tense: 'preterito', person: 'él/ella', en: 'The translator translated the document in an hour.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (comenzar) un proyecto nuevo.', inf: 'comenzar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we started a new project.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (perder) las llaves de casa.', inf: 'perder', tense: 'preterito', person: 'yo', en: 'Yesterday I lost the house keys.' },

  { type: 'cloze', level: 1, text: 'Anoche yo ___ (volver) muy tarde a casa.', inf: 'volver', tense: 'preterito', person: 'yo', en: 'Last night I got home very late.' },
  { type: 'cloze', level: 1, text: 'Ayer tú ___ (encontrar) mi cartera en el sofá.', inf: 'encontrar', tense: 'preterito', person: 'tú', en: 'Yesterday you found my wallet on the sofa.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (llegar) tarde al partido.', inf: 'llegar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we arrived late to the game.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (buscar) las entradas durante una hora.', inf: 'buscar', tense: 'preterito', person: 'yo', en: 'Yesterday I looked for the tickets for an hour.' },

  { type: 'cloze', level: 1, text: 'Ayer yo ___ (pagar) la cuenta con tarjeta.', inf: 'pagar', tense: 'preterito', person: 'yo', en: 'Yesterday I paid the bill with a card.' },
  ...
  { type: 'cloze', level: 1, text: 'Sin querer, mi hermano ___ (romper) el espejo.', inf: 'romper', tense: 'preterito', person: 'él/ella', en: 'Without meaning to, my brother broke the mirror.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer los científicos ___ (descubrir) una especie nueva.', inf: 'descubrir', tense: 'preterito', person: 'ellos', en: 'Yesterday the scientists discovered a new species.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (dejar) las maletas en el hotel.', inf: 'dejar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we left the suitcases at the hotel.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (esperar) media hora en la parada.', inf: 'esperar', tense: 'preterito', person: 'yo', en: 'Yesterday I waited half an hour at the stop.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche nosotros ___ (pasar) horas hablando.', inf: 'pasar', tense: 'preterito', person: 'nosotros', en: 'Last night we spent hours talking.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer mi profesor me ___ (ayudar) con la tarea.', inf: 'ayudar', tense: 'preterito', person: 'él/ella', en: 'Yesterday my teacher helped me with the homework.' },
  ...
  { type: 'cloze', level: 1, text: 'Esta mañana yo ___ (tomar) café con mi hermana.', inf: 'tomar', tense: 'preterito', person: 'yo', en: 'This morning I had coffee with my sister.' },

  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (comprar) un regalo para papá.', inf: 'comprar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we bought a gift for dad.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (terminar) el informe a tiempo.', inf: 'terminar', tense: 'preterito', person: 'yo', en: 'Yesterday I finished the report on time.' },
  ...
  { type: 'cloze', level: 1, text: 'El verano pasado nosotros ___ (viajar) por el sur de España.', inf: 'viajar', tense: 'preterito', person: 'nosotros', en: 'Last summer we traveled around the south of Spain.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (bailar) toda la noche en la fiesta.', inf: 'bailar', tense: 'preterito', person: 'yo', en: 'Last night I danced all night at the party.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (vender) el coche viejo.', inf: 'vender', tense: 'preterito', person: 'nosotros', en: 'Yesterday we sold the old car.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo le ___ (responder) rápido al mensaje.', inf: 'responder', tense: 'preterito', person: 'yo', en: 'Yesterday I replied to the message quickly.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (decidir) cambiar de piso.', inf: 'decidir', tense: 'preterito', person: 'nosotros', en: 'Yesterday we decided to change apartments.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (subir) las escaleras muy rápido.', inf: 'subir', tense: 'preterito', person: 'yo', en: 'Last night I went up the stairs very fast.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (cenar) muy tarde.', inf: 'cenar', tense: 'preterito', person: 'yo', en: 'Last night I had dinner very late.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer algo extraño ___ (ocurrir) en la oficina.', inf: 'ocurrir', tense: 'preterito', person: 'él/ella', en: 'Yesterday something strange happened at the office.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (invitar) a los vecinos a cenar.', inf: 'invitar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we invited the neighbors to dinner.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (olvidar) las llaves en el coche.', inf: 'olvidar', tense: 'preterito', person: 'yo', en: 'Yesterday I forgot the keys in the car.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (firmar) el contrato del piso.', inf: 'firmar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we signed the apartment contract.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (lavar) toda la ropa sucia.', inf: 'lavar', tense: 'preterito', person: 'yo', en: 'Last night I washed all the dirty clothes.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo le ___ (prometer) ayuda a mi hermano.', inf: 'prometer', tense: 'preterito', person: 'yo', en: 'Yesterday I promised my brother help.' },
  ...
  { type: 'cloze', level: 1, text: 'Al final nosotros ___ (lograr) terminar el proyecto.', inf: 'lograr', tense: 'preterito', person: 'nosotros', en: 'In the end we managed to finish the project.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer mis padres ___ (discutir) sobre las vacaciones.', inf: 'discutir', tense: 'preterito', person: 'ellos', en: 'Yesterday my parents argued about the vacation.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer algo extraño le ___ (suceder) a mi vecino.', inf: 'suceder', tense: 'preterito', person: 'él/ella', en: 'Yesterday something strange happened to my neighbor.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (cumplir) veinticinco años.', inf: 'cumplir', tense: 'preterito', person: 'yo', en: 'Yesterday I turned twenty-five.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (añadir) más sal a la sopa.', inf: 'añadir', tense: 'preterito', person: 'yo', en: 'Yesterday I added more salt to the soup.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer ella ___ (admitir) su error frente a todos.', inf: 'admitir', tense: 'preterito', person: 'él/ella', en: 'Yesterday she admitted her mistake in front of everyone.' },
  ...
  { type: 'cloze', level: 1, text: 'El año pasado nosotros ___ (sufrir) mucho estrés en el trabajo.', inf: 'sufrir', tense: 'preterito', person: 'nosotros', en: 'Last year we suffered a lot of stress at work.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (planear) las vacaciones de verano.', inf: 'planear', tense: 'preterito', person: 'nosotros', en: 'Yesterday we planned the summer vacation.' },
  ...
  { type: 'cloze', level: 1, text: 'El mes pasado yo ___ (gastar) demasiado en ropa.', inf: 'gastar', tense: 'preterito', person: 'yo', en: 'Last month I spent too much on clothes.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer la empresa ___ (contratar) a dos ingenieros.', inf: 'contratar', tense: 'preterito', person: 'él/ella', en: 'Yesterday the company hired two engineers.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (negociar) un precio mejor.', inf: 'negociar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we negotiated a better price.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer tú ___ (instalar) el programa nuevo.', inf: 'instalar', tense: 'preterito', person: 'tú', en: 'Yesterday you installed the new program.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (actualizar) todos mis dispositivos.', inf: 'actualizar', tense: 'preterito', person: 'yo', en: 'Last night I updated all my devices.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer el veterinario ___ (vacunar) a diez cachorros.', inf: 'vacunar', tense: 'preterito', person: 'él/ella', en: 'Yesterday the vet vaccinated ten puppies.' },
  ...
  { type: 'cloze', level: 1, text: 'El año pasado los médicos ___ (curar) a muchos pacientes.', inf: 'curar', tense: 'preterito', person: 'ellos', en: 'Last year the doctors cured many patients.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (votar) por el nuevo diseño.', inf: 'votar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we voted for the new design.' },
  ...
  { type: 'cloze', level: 1, text: 'El cliente ___ (reclamar) un descuento ayer.', inf: 'reclamar', tense: 'preterito', person: 'él/ella', en: 'The client demanded a discount yesterday.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer los vecinos ___ (protestar) frente al ayuntamiento.', inf: 'protestar', tense: 'preterito', person: 'ellos', en: 'Yesterday the neighbors protested in front of city hall.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (llorar) viendo esa película.', inf: 'llorar', tense: 'preterito', person: 'yo', en: 'Last night I cried watching that movie.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (descargar) la aplicación nueva.', inf: 'descargar', tense: 'preterito', person: 'nosotros', en: 'Yesterday we downloaded the new app.' },
  ...
  { type: 'cloze', level: 1, text: 'Anoche yo ___ (cargar) el teléfono antes de dormir.', inf: 'cargar', tense: 'preterito', person: 'yo', en: 'Last night I charged my phone before sleeping.' },
  ...
  { type: 'cloze', level: 1, text: 'El año pasado nosotros ___ (invertir) en una empresa nueva.', inf: 'invertir', tense: 'preterito', person: 'nosotros', en: 'Last year we invested in a new company.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (elegir) el regalo perfecto.', inf: 'elegir', tense: 'preterito', person: 'yo', en: 'Yesterday I chose the perfect gift.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer yo ___ (enviar) el informe a mi jefa.', inf: 'enviar', tense: 'preterito', person: 'yo', en: 'Yesterday I sent the report to my boss.' },
  ...
  { type: 'cloze', level: 1, text: 'Cuando vio el resultado, ella ___ (sonreír) mucho.', inf: 'sonreír', tense: 'preterito', person: 'él/ella', en: 'When she saw the result, she smiled a lot.' },
  ...
  { type: 'cloze', level: 1, text: 'Ayer nosotros ___ (decidir) cambiar de casa.', inf: 'decidir', tense: 'preterito', person: 'nosotros', en: 'Yesterday we decided to change houses.' },
