...
/* ============================================================================
 * VERB-QUEUE BATCH 1 — spec/verb-queue.json worked through in file order.
 * Skipped as non-verbs / typos found in the queue (not conjugated anywhere):
 *   collar, cadáver, póster, alfiler, taller, auricular, cáncer, celular,
 *   pajar, mártir, altar, insular, peninsular, pulgar, quehacer — all nouns
 *   or adjectives the harvester miscategorised.
 *   eflexionar — truncated typo for "reflexionar", already in the dataset.
 * ========================================================================== */
window.VERBS = window.VERBS.concat([

/* -- identidad, compras, naturaleza -------------------------------------- */
{ inf:'llamarse', en:'to be called/named', type:'ar' },
...
{ inf:'memorizar', en:'to memorise', type:'ar' },
...
/* -- cuerpo --------------------------------------------------------------- */
{ inf:'parecerse', en:'to look alike, to resemble', type:'er' },
...
{ inf:'soltar', en:'to let go of', type:'ar', stem:'ue' },
{ inf:'tumbarse', en:'to lie down', type:'ar' },
{ inf:'tirarse', en:'to throw oneself, to dive', type:'ar' },
{ inf:'incorporarse', en:'to sit up, to join (a group)', type:'ar' },
{ inf:'alzarse', en:'to rise up', type:'ar' },
{ inf:'agacharse', en:'to crouch, to bend down', type:'ar' },
{ inf:'cruzar', en:'to cross', type:'ar' },
{ inf:'rascarse', en:'to scratch (oneself)', type:'ar' },
{ inf:'arañar', en:'to scratch (with nails/claws)', type:'ar' },
...
{ inf:'aguantar', en:'to put up with, to hold up', type:'ar' },
...
{ inf:'incinerar', en:'to cremate, to incinerate', type:'ar' },

/* -- caracter --------------------------------------------------------------*/
{ inf:'alegrarse', en:'to be glad', type:'ar' },
{ inf:'divertirse', en:'to have fun', type:'ir', stem:'ie' },
...
{ inf:'avergonzarse', en:'to feel ashamed', type:'ar', forms:{
...
{ inf:'detestar', en:'to detest', type:'ar' },
{ inf:'lamentar', en:'to regret, to be sorry about', type:'ar' },
{ inf:'resignarse', en:'to resign oneself', type:'ar' },
{ inf:'agotarse', en:'to wear oneself out, to run out', type:'ar' },
...
{ inf:'envejecer', en:'to age, to grow old', type:'er' },
{ inf:'renovar', en:'to renew', type:'ar', stem:'ue' },

/* -- relaciones --------------------------------------------------------------*/
{ inf:'obedecer', en:'to obey', type:'er' },
{ inf:'desobedecer', en:'to disobey', type:'er' },
{ inf:'reñir', en:'to scold, to argue', type:'ir', ger:'riñendo', forms:{
  presente:['riño','riñes','riñe','reñimos','reñís','riñen'],
  preterito:['reñí','reñiste','riñó','reñimos','reñisteis','riñeron'],
  presubj:['riña','riñas','riña','riñamos','riñáis','riñan'] } },
{ inf:'pelearse', en:'to have a fight, to argue', type:'ar' },
{ inf:'educar', en:'to educate, to raise', type:'ar' },
{ inf:'heredar', en:'to inherit', type:'ar' },
{ inf:'llevarse', en:'to get along', type:'ar' },
{ inf:'abrazarse', en:'to hug (each other)', type:'ar' },
{ inf:'besarse', en:'to kiss (each other)', type:'ar' },
{ inf:'ligar', en:'to flirt, to pick up', type:'ar' },
{ inf:'relacionarse', en:'to socialise, to interact', type:'ar' },
...
{ inf:'mamar', en:'to nurse, to suckle', type:'ar' },
...
{ inf:'aliñar', en:'to season, to dress (a salad)', type:'ar' },
...
/* -- educacion -------------------------------------------------------------*/
{ inf:'matricularse', en:'to enrol', type:'ar' },
{ inf:'conceder', en:'to grant', type:'er' },
{ inf:'deducir', en:'to deduce, to deduct', type:'ir', forms:{
  preterito:['deduje','dedujiste','dedujo','dedujimos','dedujisteis','dedujeron'] } },
{ inf:'formarse', en:'to train, to be educated', type:'ar' },
{ inf:'educarse', en:'to be educated, to be raised', type:'ar' },
{ inf:'examinarse', en:'to sit an exam', type:'ar' },
{ inf:'licenciarse', en:'to graduate (with a degree)', type:'ar' },
{ inf:'titularse', en:'to graduate, to be titled', type:'ar' },
{ inf:'doctorarse', en:'to get a doctorate', type:'ar' },
...
/* -- trabajo ---------------------------------------------------------------*/
{ inf:'ocupar', en:'to occupy, to take up', type:'ar' },
...
/* -- ocio --------------------------------------------------------------- */
{ inf:'inscribirse', en:'to enrol, to sign up', type:'ir', part:'inscrito' },
{ inf:'coleccionar', en:'to collect', type:'ar' },
{ inf:'entretenerse', en:'to amuse oneself', type:'er', like:'tener' },
{ inf:'disfrazarse', en:'to dress up, to wear a costume', type:'ar' },
{ inf:'estrenar', en:'to use/wear for the first time, to premiere', type:'ar' },
{ inf:'inaugurar', en:'to inaugurate, to open', type:'ar' },
{ inf:'empatar', en:'to draw, to tie (a game)', type:'ar' },
{ inf:'hacerse', en:'to become', type:'er', part:'hecho', forms:{
  presente:['hago','haces','hace','hacemos','hacéis','hacen'],
  preterito:['hice','hiciste','hizo','hicimos','hicisteis','hicieron'],
  futuro:['haré','harás','hará','haremos','haréis','harán'],
  condicional:['haría','harías','haría','haríamos','haríais','harían'],
  presubj:['haga','hagas','haga','hagamos','hagáis','hagan'] } },
{ inf:'vencer', en:'to defeat, to win', type:'er' },
{ inf:'acertar', en:'to get right, to guess correctly', type:'ar', stem:'ie' },
{ inf:'fallar', en:'to fail, to miss', type:'ar' },
{ inf:'clasificarse', en:'to qualify (sport)', type:'ar' },
{ inf:'barajar', en:'to shuffle (cards), to consider (options)', type:'ar' },
{ inf:'repartir', en:'to distribute, to deal', type:'ir' },
{ inf:'echar', en:'to throw, to pour', type:'ar' },
{ inf:'apostar', en:'to bet', type:'ar', stem:'ue' },
{ inf:'saltarse', en:'to skip, to jump (a light/queue)', type:'ar' },

/* -- medios ------------------------------------------------------------- */
{ inf:'informar', en:'to inform', type:'ar' },
{ inf:'mantenerse', en:'to stay, to support oneself', type:'er', like:'tener' },
{ inf:'comentar', en:'to comment on', type:'ar' },
{ inf:'comunicar', en:'to communicate, to convey', type:'ar' },
{ inf:'declarar', en:'to declare, to state', type:'ar' },
{ inf:'comunicarse', en:'to communicate (with each other)', type:'ar' },
{ inf:'certificar', en:'to certify', type:'ar' },
{ inf:'entregar', en:'to hand over, to deliver', type:'ar' },
{ inf:'descolgar', en:'to pick up (the phone), to take down', type:'ar', stem:'ue' },
{ inf:'colgar', en:'to hang (up)', type:'ar', stem:'ue' },
{ inf:'titular', en:'to title, to headline', type:'ar' },
{ inf:'grabar', en:'to record', type:'ar' },
{ inf:'perderse', en:'to get lost, to miss out on', type:'er', stem:'ie' },
{ inf:'descargarse', en:'to download', type:'ar' },
{ inf:'bajarse', en:'to get off, to download', type:'ar' },
{ inf:'adjuntar', en:'to attach', type:'ar' },
{ inf:'manejar', en:'to handle, to operate', type:'ar' },
...
{ inf:'iluminar', en:'to light up, to illuminate', type:'ar' },
{ inf:'desenchufar', en:'to unplug', type:'ar' },
{ inf:'enchufar', en:'to plug in', type:'ar' },
{ inf:'estropearse', en:'to break down, to go wrong', type:'ar' },
{ inf:'averiarse', en:'to break down (a machine)', type:'ar', stem:'í' },

/* -- salud / servicios / compras (mixed, per queue order) --------------- */
{ inf:'ingresar', en:'to be admitted (hospital), to deposit', type:'ar' },
{ inf:'robar', en:'to steal, to rob', type:'ar' },
{ inf:'detener', en:'to stop, to arrest', type:'er', like:'tener' },
{ inf:'interrogar', en:'to interrogate, to question', type:'ar' },
...
{ inf:'romperse', en:'to break (a bone/object)', type:'er', part:'roto' },
{ inf:'engordar', en:'to put on weight', type:'ar' },
{ inf:'escayolar', en:'to put in a cast', type:'ar' },
{ inf:'vendar', en:'to bandage', type:'ar' },
{ inf:'vomitar', en:'to vomit', type:'ar' },
{ inf:'marearse', en:'to feel dizzy/sick', type:'ar' },
{ inf:'hospitalizar', en:'to hospitalise', type:'ar' },
{ inf:'vacunarse', en:'to get vaccinated', type:'ar' },
{ inf:'recetar', en:'to prescribe', type:'ar' },
{ inf:'limarse', en:'to file (nails)', type:'ar' },
{ inf:'desenredarse', en:'to untangle (oneself)', type:'ar' },
{ inf:'enredarse', en:'to get tangled up', type:'ar' },
{ inf:'recogerse', en:'to tie back (hair), to retire for the night', type:'er' },
{ inf:'pintarse', en:'to put on makeup', type:'ar' },
{ inf:'conservarse', en:'to keep well, to age well', type:'ar' },
{ inf:'recortarse', en:'to trim (one\'s own hair/beard)', type:'ar' },
...
{ inf:'aterrizar', en:'to land', type:'ar' },
...
{ inf:'sumar', en:'to add up', type:'ar' },
...
{ inf:'pegar', en:'to stick, to hit', type:'ar' },
...
{ inf:'convocar', en:'to summon, to call (a meeting/election)', type:'ar' },
{ inf:'cometer', en:'to commit', type:'er' },
{ inf:'disparar', en:'to shoot', type:'ar' },
{ inf:'defender', en:'to defend', type:'er', stem:'ie' },

/* -- arte ------------------------------------------------------------------*/
{ inf:'componer', en:'to compose', type:'er', like:'poner' },
{ inf:'imitar', en:'to imitate', type:'ar' },
{ inf:'describir', en:'to describe', type:'ir', like:'escribir' },
{ inf:'relatar', en:'to relate, to narrate', type:'ar' },
...
{ inf:'escenificar', en:'to stage, to dramatise', type:'ar' },

/* -- religion --------------------------------------------------------------*/
{ inf:'rezar', en:'to pray', type:'ar' },
{ inf:'bendecir', en:'to bless', type:'ir', part:'bendecido', ger:'bendiciendo', forms:{
...
{ inf:'confesarse', en:'to confess', type:'ar', stem:'ie' },
{ inf:'comulgar', en:'to take communion', type:'ar' },
{ inf:'convertirse', en:'to turn into, to convert', type:'ir', stem:'ie' },
{ inf:'razonar', en:'to reason', type:'ar' },

/* -- naturaleza --------------------------------------------------------- */
{ inf:'brillar', en:'to shine', type:'ar' },
{ inf:'apagarse', en:'to go out (fire/light)', type:'ar' },
{ inf:'limitar', en:'to limit, to border', type:'ar' },
{ inf:'plantar', en:'to plant', type:'ar' },
{ inf:'cultivar', en:'to cultivate, to grow', type:'ar' },
{ inf:'sembrar', en:'to sow', type:'ar', stem:'ie' },
{ inf:'nublarse', en:'to cloud over', type:'ar' },
{ inf:'soplar', en:'to blow', type:'ar' },
{ inf:'helar', en:'to freeze (weather)', type:'ar', stem:'ie' },
{ inf:'granizar', en:'to hail', type:'ar' },
{ inf:'caerse', en:'to fall down', type:'er', part:'caído', ger:'cayendo', forms:{
  presente:['caigo','caes','cae','caemos','caéis','caen'],
  preterito:['caí','caíste','cayó','caímos','caísteis','cayeron'],
  presubj:['caiga','caigas','caiga','caigamos','caigáis','caigan'] } },
{ inf:'secarse', en:'to dry (up)', type:'ar' },
{ inf:'brotar', en:'to sprout, to break out', type:'ar' },
{ inf:'florecer', en:'to flower, to flourish', type:'er' },
...
/* ============================================================================
 * VERB-QUEUE BATCH 2 — the C1 half of spec/verb-queue.json, same file order.
 * Skipped as non-verbs found in the queue: quehacer (noun, "chore"), auricular
 * (noun/adj, "earpiece"), pajar (noun, "hayloft"), celular (adj/noun, not a
 * verb), mártir, altar (nouns).
 * Also skipped: unirse (politica, "to join/unite") — its regular presubj/
 * imperativo ("una", "unas") is spelled exactly like the indefinite article,
 * a top-50-frequency word. Unlike the noun/verb homographs elsewhere, this
 * collision cannot be gated by determiner-adjacency (the article usually
 * isn't preceded by one) without a real POS tagger, so the fix is not to add
 * this specific verb rather than build one.
 * ========================================================================== */
window.VERBS = window.VERBS.concat([

/* -- cuerpo ----------------------------------------------------------------*/
{ inf:'aspirar', en:'to inhale, to aspire to', type:'ar' },
{ inf:'espirar', en:'to exhale', type:'ar' },
{ inf:'tiritar', en:'to shiver', type:'ar' },
{ inf:'estremecerse', en:'to shudder', type:'er' },
{ inf:'arrugar', en:'to wrinkle, to crease', type:'ar' },
{ inf:'alzar', en:'to raise, to lift', type:'ar' },
{ inf:'distender', en:'to relax, to loosen (a muscle)', type:'er', stem:'ie' },
...
{ inf:'morirse', en:'to die', type:'ir', stem:'ue', part:'muerto' },
{ inf:'agradar', en:'to please', type:'ar' },
{ inf:'fascinar', en:'to fascinate', type:'ar' },
{ inf:'enorgullecerse', en:'to take pride', type:'er' },
{ inf:'alucinar', en:'to be amazed, to hallucinate', type:'ar' },
{ inf:'asombrarse', en:'to be astonished', type:'ar' },
{ inf:'aborrecer', en:'to loathe', type:'er' },
{ inf:'desagradar', en:'to displease', type:'ar' },
{ inf:'repugnar', en:'to disgust', type:'ar' },
{ inf:'entristecerse', en:'to become sad', type:'er' },
{ inf:'inquietarse', en:'to become uneasy', type:'ar' },
{ inf:'agobiarse', en:'to feel overwhelmed', type:'ar' },
{ inf:'desanimarse', en:'to get discouraged', type:'ar' },
{ inf:'derrumbarse', en:'to collapse, to break down', type:'ar' },
{ inf:'hundirse', en:'to sink, to fall apart', type:'ir' },
{ inf:'recuperarse', en:'to recover', type:'ar' },
{ inf:'compadecer', en:'to feel sorry for', type:'er' },
{ inf:'arrepentirse', en:'to regret', type:'ir', stem:'ie' },
{ inf:'aguantarse', en:'to put up with it, to resign oneself', type:'ar' },
{ inf:'fastidiarse', en:'to get annoyed, to put up with it', type:'ar' },
...
{ inf:'afrontar', en:'to face up to', type:'ar' },

/* -- identidad ---------------------------------------------------------- */
{ inf:'residir', en:'to reside', type:'ir' },
{ inf:'habitar', en:'to inhabit, to live in', type:'ar' },
{ inf:'tramitar', en:'to process (paperwork)', type:'ar' },
{ inf:'enviudar', en:'to be widowed', type:'ar' },
{ inf:'expedir', en:'to issue (a document)', type:'ir', stem:'i' },
{ inf:'sacarse', en:'to get (a qualification/document)', type:'ar' },
...
{ inf:'oponerse', en:'to be opposed to', type:'er', like:'poner' },
{ inf:'enfrentarse', en:'to confront, to face', type:'ar' },
{ inf:'regañar', en:'to tell off, to scold', type:'ar' },
{ inf:'enfriarse', en:'to cool down, to grow cold', type:'ar', stem:'í' },
{ inf:'estrechar', en:'to tighten, to strengthen (ties)', type:'ar' },
{ inf:'vincularse', en:'to become linked', type:'ar' },
{ inf:'mezclarse', en:'to mix, to get mixed up in', type:'ar' },
{ inf:'presidir', en:'to preside over', type:'ir' },
{ inf:'clausurar', en:'to close (formally)', type:'ar' },
...
/* -- alimentacion --------------------------------------------------------- */
{ inf:'adulterar', en:'to adulterate, to tamper with', type:'ar' },
{ inf:'interrumpir', en:'to interrupt', type:'ir' },
{ inf:'descomponerse', en:'to go off, to break down', type:'er', like:'poner' },
{ inf:'succionar', en:'to suck up', type:'ar' },
{ inf:'sorber', en:'to sip, to slurp', type:'er' },
{ inf:'catar', en:'to taste, to sample', type:'ar' },
{ inf:'subirse', en:'to go up, to climb up', type:'ir' },
{ inf:'moler', en:'to grind', type:'er', stem:'ue' },
{ inf:'pasarse', en:'to go too far, to go off (food)', type:'ar' },
{ inf:'pegarse', en:'to stick together, to get stuck', type:'ar' },

/* -- educacion -------------------------------------------------------------*/
{ inf:'otorgar', en:'to grant, to award', type:'ar' },
{ inf:'convalidar', en:'to validate, to recognise (a qualification)', type:'ar' },
{ inf:'cursar', en:'to study, to take (a course)', type:'ar' },
{ inf:'acreditar', en:'to accredit, to prove', type:'ar' },
{ inf:'sancionar', en:'to sanction, to penalise', type:'ar' },
...
{ inf:'asimilar', en:'to assimilate, to take in', type:'ar' },
{ inf:'inducir', en:'to induce', type:'ir', forms:{
  preterito:['induje','indujiste','indujo','indujimos','indujisteis','indujeron'] } },
{ inf:'empollar', en:'to cram, to study hard', type:'ar' },
{ inf:'examinar', en:'to examine', type:'ar' },
{ inf:'retomar', en:'to resume, to take up again', type:'ar' },

/* -- trabajo ---------------------------------------------------------------*/
{ inf:'ejecutar', en:'to execute, to carry out', type:'ar' },
{ inf:'volcarse', en:'to throw oneself (into something)', type:'ar', stem:'ue' },
{ inf:'acumularse', en:'to build up, to pile up', type:'ar' },
{ inf:'delegar', en:'to delegate', type:'ar' },
{ inf:'centralizar', en:'to centralise', type:'ar' },
...
{ inf:'sindicarse', en:'to unionise', type:'ar' },
{ inf:'afiliarse', en:'to join, to become a member', type:'ar' },

/* -- ocio --------------------------------------------------------------- */
{ inf:'distraerse', en:'to get distracted, to amuse oneself', type:'er', like:'traer' },
{ inf:'trasnochar', en:'to stay up all night', type:'ar' },
{ inf:'disputar', en:'to dispute, to compete for', type:'ar' },
...
{ inf:'conquistar', en:'to conquer, to win over', type:'ar' },
{ inf:'festejar', en:'to celebrate', type:'ar' },
{ inf:'aceptar', en:'to accept', type:'ar' },

/* -- medios --------------------------------------------------------------- */
{ inf:'notificar', en:'to notify', type:'ar' },
{ inf:'contrastar', en:'to contrast, to check against', type:'ar' },
{ inf:'desvelar', en:'to reveal, to keep awake', type:'ar' },
{ inf:'remitir', en:'to send, to refer to', type:'ir' },
{ inf:'fechar', en:'to date (a document)', type:'ar' },
{ inf:'dictar', en:'to dictate', type:'ar' },
{ inf:'descifrar', en:'to decipher', type:'ar' },
{ inf:'escribirse', en:'to write to each other', type:'ir', part:'escrito' },
{ inf:'cartearse', en:'to correspond by letter', type:'ar' },
{ inf:'abonarse', en:'to subscribe', type:'ar' },
{ inf:'pactar', en:'to agree on, to negotiate', type:'ar' },
...
{ inf:'saturarse', en:'to become saturated, to overload', type:'ar' },

/* -- vivienda --------------------------------------------------------------*/
{ inf:'derribar', en:'to demolish, to knock down', type:'ar' },
{ inf:'edificar', en:'to build', type:'ar' },
...
{ inf:'centrifugar', en:'to spin (laundry)', type:'ar' },
...
{ inf:'desactivar', en:'to deactivate, to defuse', type:'ar' },
{ inf:'detectar', en:'to detect', type:'ar' },
{ inf:'estallar', en:'to explode, to break out', type:'ar' },
{ inf:'hallar', en:'to find', type:'ar' },
{ inf:'acoger', en:'to welcome, to take in', type:'er' },
{ inf:'integrarse', en:'to integrate, to fit in', type:'ar' },
{ inf:'socorrer', en:'to help, to rescue', type:'er' },
{ inf:'aislar', en:'to isolate', type:'ar', stem:'í' },
{ inf:'producirse', en:'to occur, to happen', type:'ir', forms:{
  preterito:['produje','produjiste','produjo','produjimos','produjisteis','produjeron'] } },

/* -- compras ----------------------------------------------------------- */
{ inf:'comercializar', en:'to market, to sell commercially', type:'ar' },
{ inf:'subastar', en:'to auction', type:'ar' },
{ inf:'fidelizar', en:'to build loyalty (of customers)', type:'ar' },
{ inf:'traspasar', en:'to transfer, to pass over', type:'ar' },
{ inf:'vestir', en:'to dress, to wear', type:'ir', stem:'i' },
{ inf:'rozar', en:'to brush against, to border on', type:'ar' },
{ inf:'desembolsar', en:'to pay out, to disburse', type:'ar' },
{ inf:'aplazar', en:'to postpone', type:'ar' },
{ inf:'agilizar', en:'to speed up', type:'ar' },
{ inf:'malgastar', en:'to waste, to squander', type:'ar' },

/* -- salud -------------------------------------------------------------- */
{ inf:'agravarse', en:'to get worse', type:'ar' },
{ inf:'agudizarse', en:'to intensify, to get sharper', type:'ar' },
{ inf:'incubar', en:'to incubate', type:'ar' },
{ inf:'degenerar', en:'to degenerate', type:'ar' },
{ inf:'gozar', en:'to enjoy', type:'ar' },
{ inf:'extenderse', en:'to spread, to stretch out', type:'er', stem:'ie' },
{ inf:'inflamar', en:'to inflame', type:'ar' },
{ inf:'infectar', en:'to infect', type:'ar' },
{ inf:'cicatrizar', en:'to heal, to scar over', type:'ar' },
{ inf:'picar', en:'to sting, to itch, to snack', type:'ar' },
{ inf:'escocer', en:'to sting, to smart', type:'er', forms:{
...
{ inf:'delirar', en:'to be delirious', type:'ar' },
{ inf:'desmayarse', en:'to faint', type:'ar' },
{ inf:'desvanecerse', en:'to faint, to fade away', type:'er' },
{ inf:'donar', en:'to donate', type:'ar' },
{ inf:'inyectar', en:'to inject', type:'ar' },
{ inf:'dosificar', en:'to dose, to measure out', type:'ar' },
{ inf:'ingerir', en:'to ingest', type:'ir', stem:'ie' },
{ inf:'tolerar', en:'to tolerate', type:'ar' },
{ inf:'enjabonar', en:'to soap up', type:'ar' },
{ inf:'depilarse', en:'to wax/shave (body hair)', type:'ar' },
{ inf:'teñirse', en:'to dye (one\'s own hair)', type:'ir', ger:'tiñendo', forms:{
...
{ inf:'dejarse', en:'to let oneself, to leave behind (accidentally)', type:'ar' },
{ inf:'darse', en:'to give oneself, to happen', type:'ar', forms:{
  presente:['doy','das','da','damos','dais','dan'],
  preterito:['di','diste','dio','dimos','disteis','dieron'],
  presubj:['dé','des','dé','demos','deis','den'] } },

/* -- viajes ------------------------------------------------------------- */
{ inf:'orientarse', en:'to get one\'s bearings', type:'ar' },
{ inf:'trasladarse', en:'to relocate, to move', type:'ar' },
{ inf:'desplazarse', en:'to travel, to get around', type:'ar' },
{ inf:'ascender', en:'to ascend, to get promoted', type:'er', stem:'ie' },
{ inf:'trepar', en:'to climb', type:'ar' },
{ inf:'descender', en:'to descend, to go down', type:'er', stem:'ie' },
{ inf:'deslizarse', en:'to slide, to slip', type:'ar' },
{ inf:'tripular', en:'to crew, to man (a vehicle)', type:'ar' },
...
{ inf:'lanzarse', en:'to throw oneself, to launch into', type:'ar' },
{ inf:'circular', en:'to circulate, to drive, to flow', type:'ar' },
{ inf:'infringir', en:'to infringe, to break (a rule)', type:'ir' },
...
{ inf:'amortizar', en:'to pay off, to amortise', type:'ar' },
{ inf:'rentabilizar', en:'to make profitable', type:'ar' },
{ inf:'devaluarse', en:'to lose value, to devalue', type:'ar', stem:'ú' },
{ inf:'depreciarse', en:'to depreciate', type:'ar' },
{ inf:'revalorizarse', en:'to appreciate, to gain value', type:'ar' },
{ inf:'cotizar', en:'to be quoted (on a market), to pay into (social security)', type:'ar' },
{ inf:'endeudarse', en:'to get into debt', type:'ar' },
...
{ inf:'disolverse', en:'to dissolve', type:'er', stem:'ue', part:'disuelto' },
{ inf:'arruinarse', en:'to be ruined, to go broke', type:'ar' },
{ inf:'industrializar', en:'to industrialise', type:'ar' },
{ inf:'cosechar', en:'to harvest', type:'ar' },
{ inf:'ordeñar', en:'to milk (an animal)', type:'ar' },

/* -- ciencia -----------------------------------------------------------  */
{ inf:'extinguirse', en:'to become extinct, to go out', type:'ir' },
{ inf:'comprimir', en:'to compress', type:'ir' },

/* -- politica ----------------------------------------------------------- */
{ inf:'asociarse', en:'to form an association, to team up', type:'ar' },
{ inf:'agruparse', en:'to group together', type:'ar' },
{ inf:'confederarse', en:'to form a confederation', type:'ar' },
{ inf:'federarse', en:'to federate', type:'ar' },
{ inf:'marginar', en:'to marginalise', type:'ar' },
{ inf:'discriminar', en:'to discriminate against', type:'ar' },
{ inf:'segregar', en:'to segregate', type:'ar' },
{ inf:'legislar', en:'to legislate', type:'ar' },
{ inf:'testificar', en:'to testify', type:'ar' },
{ inf:'burlar', en:'to evade, to outwit', type:'ar' },
{ inf:'invadir', en:'to invade', type:'ir' },
{ inf:'asaltar', en:'to assault, to raid', type:'ar' },
{ inf:'derrotar', en:'to defeat', type:'ar' },
{ inf:'desarmar', en:'to disarm', type:'ar' },
{ inf:'rendirse', en:'to surrender, to give up', type:'ir', stem:'i' },
{ inf:'desertar', en:'to desert', type:'ar' },

/* -- arte --------------------------------------------------------------- */
{ inf:'alabar', en:'to praise', type:'ar' },
{ inf:'tasar', en:'to appraise, to value', type:'ar' },
{ inf:'falsificar', en:'to forge, to falsify', type:'ar' },
{ inf:'rehabilitar', en:'to rehabilitate, to renovate', type:'ar' },
{ inf:'habilitar', en:'to fit out, to enable', type:'ar' },
...
/* -- religion --------------------------------------------------------------*/
{ inf:'reencarnarse', en:'to be reincarnated', type:'ar' },
{ inf:'resucitar', en:'to rise from the dead, to revive', type:'ar' },
{ inf:'salvarse', en:'to be saved', type:'ar' },
{ inf:'condenarse', en:'to be damned, to be condemned', type:'ar' },

/* -- naturaleza ----------------------------------------------------------- */
{ inf:'desembocar', en:'to flow into, to lead to', type:'ar' },
{ inf:'desbordarse', en:'to overflow (a river)', type:'ar' },
{ inf:'abonar', en:'to fertilise, to pay', type:'ar' },
...
{ inf:'embestir', en:'to charge (like a bull)', type:'ir', stem:'i' },
{ inf:'reptar', en:'to crawl, to slither', type:'ar' },
{ inf:'aparearse', en:'to mate', type:'ar' },
{ inf:'reproducirse', en:'to reproduce, to breed', type:'ir', forms:{
...
{ inf:'fertilizar', en:'to fertilise', type:'ar' },
