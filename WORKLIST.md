...
- [x] **Tiempos verbales de indicativo** · 21 pts · `gramatica C1 § 9.1. Tiempos verbales de indicativ`  — gr-tiempos-indicativo-c1
...
- [x] **Cualidad general** · 9 pts · `nociones_generales C1 § 1.4. Cualidad general`  — nt-cualidad-general-c1
- [x] **Acontecimiento** · 5 pts · `nociones_generales C1 § 1.5. Acontecimiento`  — nt-acontecimiento-c1
- [x] **Certeza, incertidumbre** · 13 pts · `nociones_generales C1 § 1.6. Certeza, incertidumbre`  — nt-certeza-incertidumbre-c1
- [x] **Realidad, ficción** · 17 pts · `nociones_generales C1 § 1.7. Realidad, ficción`  — nt-realidad-ficcion-c1
- [x] **Necesidad, contingencia, obligación** · 12 pts · `nociones_generales C1 § 1.8. Necesidad, contingencia, obli`  — nt-necesidad-obligacion-c1
- [x] **Generalidad, especificidad** · 13 pts · `nociones_generales C1 § 1.9. Generalidad, especificidad`  — nt-generalidad-especificidad-c1
- [x] **Cantidad numérica** · 4 pts · `nociones_generales C1 § 2.1. Cantidad numérica`  — nt-cantidad-numerica-c1
- [x] **Cantidad relativa** · 13 pts · `nociones_generales C1 § 2.2. Cantidad relativa`  — nt-cantidad-relativa-c1
...
- [x] **Localización** · 8 pts · `nociones_generales C1 § 3.1. Localización`  — nt-localizacion-c1
- [x] **Posición absoluta** · 12 pts · `nociones_generales C1 § 3.2. Posición absoluta`  — nt-posicion-absoluta-c1
- [x] **Posición relativa** · 19 pts · `nociones_generales C1 § 3.3. Posición relativa`  — nt-posicion-relativa-c1
- [ ] **Distancia** · 12 pts · `nociones_generales C1 § 3.4. Distancia`
- [x] **Movimiento, estabilidad** · 36 pts · `nociones_generales C1 § 3.5. Movimiento, estabilidad`  — nt-movimiento-estabilidad-sustantivos-c1, nt-movimiento-verbos-especificos-c1, nt-movimiento-locuciones-c1
- [x] **Orientación, dirección** · 11 pts · `nociones_generales C1 § 3.6. Orientación, dirección`  — nt-orientacion-direccion-c1
- [x] **Orden** · 8 pts · `nociones_generales C1 § 3.7. Orden`  — nt-orden-c1
- [x] **Origen** · 5 pts · `nociones_generales C1 § 3.8. Origen`  — nt-origen-c1
...
- [x] **Calidad** · 3 pts · `nociones_generales C1 § 6.4. Calidad`  — nt-atractivo-calidad-c1
- [x] **Aceptabilidad** · 10 pts · `nociones_generales C1 § 6.5. Aceptabilidad`  — nt-aceptabilidad-c1
- [x] **Adecuación** · 9 pts · `nociones_generales C1 § 6.6. Adecuación`  — nt-adecuacion-c1
- [x] **Conformidad** · 7 pts · `nociones_generales C1 § 6.7. Conformidad`  — nt-conformidad-c1
- [x] **Corrección** · 14 pts · `nociones_generales C1 § 6.8. Corrección`  — nt-correccion-c1
- [x] **Precisión, claridad** · 15 pts · `nociones_generales C1 § 6.9. Precisión, claridad`  — nt-precision-claridad-c1
- [x] **Interés** · 10 pts · `nociones_generales C1 § 6.10. Interés`  — nt-interes-c1
...
- [x] **Pedir confirmación** · 19 pts · `funciones C1 § 1.4. Pedir confirmación`  — fn-pedir-confirmacion-c1
- [x] **Confirmar la información previa** · 4 pts · `funciones C1 § 1.5. Confirmar la información prev`  — fn-confirmar-informacion-previa-c1
- [x] **Pedir opinión** · 11 pts · `funciones C1 § 2.1. Pedir opinión`  — fn-pedir-dar-opinion-c1
- [x] **Dar una opinión** · 4 pts · `funciones C1 § 2.2. Dar una opinión`  — fn-pedir-dar-opinion-c1
- [x] **Valorar** · 3 pts · `funciones C1 § 2.4. Valorar`  — fn-valorar-c1
- [x] **Expresar aprobación y desaprobación** · 9 pts · `funciones C1 § 2.5. Expresar aprobación y desapro`  — fn-aprobacion-desaprobacion-c1
- [x] **Expresar acuerdo** · 21 pts · `funciones C1 § 2.9. Expresar acuerdo`  — fn-expresar-acuerdo-c1
- [x] **Expresar desacuerdo** · 20 pts · `funciones C1 § 2.10. Expresar desacuerdo`  — fn-expresar-desacuerdo-c1
- [x] **Mostrar escepticismo** · 3 pts · `funciones C1 § 2.11. Mostrar escepticismo`  — fn-escepticismo-contraargumento-c1
- [x] **Presentar un contraargumento** · 4 pts · `funciones C1 § 2.12. Presentar un contraargumento`  — fn-escepticismo-contraargumento-c1
- [x] **Expresar certeza y evidencia** · 10 pts · `funciones C1 § 2.13. Expresar certeza y evidencia`  — fn-certeza-evidencia-c1
...
- [x] **Preguntar por el conocimiento de algo** · 7 pts · `funciones C1 § 2.19. Preguntar por el conocimient`  — fn-conocimiento-desconocimiento-c1
- [x] **Expresar conocimiento** · 4 pts · `funciones C1 § 2.20. Expresar conocimiento`  — fn-conocimiento-desconocimiento-c1
- [x] **Expresar desconocimiento** · 5 pts · `funciones C1 § 2.21. Expresar desconocimiento`  — fn-conocimiento-desconocimiento-c1
- [x] **Expresar habilidad para hacer algo** · 5 pts · `funciones C1 § 2.23. Expresar habilidad para hace`  — fn-habilidad-c1
- [x] **Preguntar si se recuerda o se ha olvidado** · 3 pts · `funciones C1 § 2.24. Preguntar si se recuerda o s`  — fn-recordar-olvidar-c1
- [x] **Expresar que se recuerda** · 5 pts · `funciones C1 § 2.25. Expresar que se recuerda`  — fn-recordar-olvidar-c1
...
- [x] **Expresar deseos** · 7 pts · `funciones C1 § 3.8. Expresar deseos`  — fn-deseos-planes-c1
- [x] **Expresar planes e intenciones** · 5 pts · `funciones C1 § 3.10. Expresar planes e intencione`  — fn-deseos-planes-c1
- [x] **Preguntar por el estado de ánimo** · 9 pts · `funciones C1 § 3.11. Preguntar por el estado de á`  — fn-estado-animo-alegria-c1
- [x] **Expresar alegría y satisfacción** · 8 pts · `funciones C1 § 3.12. Expresar alegría y satisfacc`  — fn-estado-animo-alegria-c1
- [x] **Expresar tristeza y aflicción** · 9 pts · `funciones C1 § 3.13. Expresar tristeza y aflicció`  — fn-tristeza-placer-c1
- [x] **Expresar placer y diversión** · 3 pts · `funciones C1 § 3.14. Expresar placer y diversión`  — fn-tristeza-placer-c1
- [x] **Expresar hartazgo** · 3 pts · `funciones C1 § 3.16. Expresar hartazgo`  — fn-hartazgo-enfado-c1
- [x] **Expresar enfado e indignación** · 6 pts · `funciones C1 § 3.17. Expresar enfado e indignació`  — fn-hartazgo-enfado-c1
- [x] **Expresar miedo, ansiedad y preocupación** · 10 pts · `funciones C1 § 3.18. Expresar miedo, ansiedad y p`  — fn-miedo-nerviosismo-c1
- [x] **Expresar nerviosismo** · 7 pts · `funciones C1 § 3.19. Expresar nerviosismo`  — fn-miedo-nerviosismo-c1
- [x] **Expresar empatía** · 5 pts · `funciones C1 § 3.20. Expresar empatía`  — fn-empatia-alivio-esperanza-c1
- [x] **Expresar alivio** · 4 pts · `funciones C1 § 3.21. Expresar alivio`  — fn-empatia-alivio-esperanza-c1
- [x] **Expresar esperanza** · 6 pts · `funciones C1 § 3.22. Expresar esperanza`  — fn-empatia-alivio-esperanza-c1
- [x] **Expresar decepción** · 3 pts · `funciones C1 § 3.23. Expresar decepción`  — fn-decepcion-resignacion-c1
...
- [x] **Expresar afecto** · 3 pts · `funciones C1 § 3.29. Expresar afecto`  — fn-afecto-sensaciones-c1
- [x] **Expresar sensaciones físicas** · 16 pts · `funciones C1 § 3.30. Expresar sensaciones físicas`  — fn-afecto-sensaciones-c1
- [x] **Dar una orden o instrucción** · 29 pts · `funciones C1 § 4.1. Dar una orden o instrucción`  — fn-orden-instruccion-c1
...
- [x] **Pedir permiso** · 4 pts · `funciones C1 § 4.8. Pedir permiso`  — fn-permiso-prohibicion-c1
- [x] **Dar permiso** · 9 pts · `funciones C1 § 4.9. Dar permiso`  — fn-permiso-prohibicion-c1
- [x] **Rechazar una prohibición** · 3 pts · `funciones C1 § 4.12. Rechazar una prohibición`  — fn-permiso-prohibicion-c1
- [x] **Proponer y sugerir** · 7 pts · `funciones C1 § 4.13. Proponer y sugerir`  — fn-proponer-ofrecer-confirmar-c1
- [x] **Ofrecer e invitar** · 3 pts · `funciones C1 § 4.14. Ofrecer e invitar`  — fn-proponer-ofrecer-confirmar-c1
...
- [x] **Reprochar** · 8 pts · `funciones C1 § 4.21. Reprochar`  — fn-reprochar-ofrecerse-c1
- [x] **Ofrecerse para hacer algo** · 10 pts · `funciones C1 § 4.23. Ofrecerse para hacer algo`  — fn-reprochar-ofrecerse-c1
- [x] **Tranquilizar y consolar** · 11 pts · `funciones C1 § 4.24. Tranquilizar y consolar`  — fn-tranquilizar-animar-c1
- [x] **Animar** · 10 pts · `funciones C1 § 4.25. Animar`  — fn-tranquilizar-animar-c1
- [x] **Saludar** · 23 pts · `funciones C1 § 5.1. Saludar`  — fn-saludar-c1 (only 6 raw PCIC points found for this subsection despite the 23-pt unit weight; covered exhaustively, skip-with-reason per brief)
- [x] **Responder a un saludo** · 8 pts · `funciones C1 § 5.2. Responder a un saludo`  — fn-responder-saludo-dirigirse-c1
...
- [x] **Destacar un elemento** · 4 pts · `funciones C1 § 6.15. Destacar un elemento`  — fn-destacar-silencio-tema-cierre-c1
- [x] **Pedir a alguien que guarde silencio** · 4 pts · `funciones C1 § 6.23. Pedir a alguien que guarde s`  — fn-destacar-silencio-tema-cierre-c1
...
- [x] C1 — batch of 10 (0/80 written)
- [x] C1 — batch of 10 (10/80 written)
- [x] C1 — batch of 10 (20/80 written)
- [x] C1 — batch of 10 (30/80 written)
- [x] C1 — batch of 10 (40/80 written)
- [x] C1 — batch of 10 (50/80 written)
- [x] C1 — batch of 10 (60/80 written)
- [x] C1 — batch of 10 (70/80 written)
...
- [x] B2 — batch of 10 (10/120 written)
- [x] B2 — batch of 10 (20/120 written)
- [x] B2 — batch of 10 (30/120 written)
- [x] B2 — batch of 10 (40/120 written)
- [x] B2 — batch of 10 (50/120 written)
- [x] B2 — batch of 10 (60/120 written)
- [x] B2 — batch of 10 (70/120 written)
- [x] B2 — batch of 10 (80/120 written)
- [x] B2 — batch of 10 (90/120 written)
- [x] B2 — batch of 10 (100/120 written)
- [x] B2 — batch of 10 (110/120 written)
- [x] C1 — batch of 10 (0/120 written)
- [x] C1 — batch of 10 (10/120 written)
- [x] C1 — batch of 10 (20/120 written)
- [x] C1 — batch of 10 (30/120 written)
- [x] C1 — batch of 10 (40/120 written)
- [x] C1 — batch of 10 (50/120 written)
- [x] C1 — batch of 10 (60/120 written)
- [x] C1 — batch of 10 (70/120 written)
- [x] C1 — batch of 10 (80/120 written)
- [x] C1 — batch of 10 (90/120 written)
- [x] C1 — batch of 10 (100/120 written)
- [x] C1 — batch of 10 (110/120 written)
